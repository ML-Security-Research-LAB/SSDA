    ...
    def forward(self, model):
        ...
        for name, module in model.named_modules():
            ...
            if isinstance(module, nn.Conv2d):
                ...
                sigmas += torch.trace(torch.matmul(W, W.t()))
                count += 1
...
def train_target(args):
    ...
    for iter_num in pbar:
        ...
        if args.cls_par > 0:
            ...
            classifier_loss *= 1#args.cls_par
        ...
        if args.opl:
            # orthogonal_loss = sep(features_test, pred)
        ...
        pbar.set_postfix({'cls loss': classifier_loss.item(), 'sval norm':norm, 'lambda': lambda_})
